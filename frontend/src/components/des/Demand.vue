...
<template>
  <div class="demand">
    ...
    <div class="demand-description">
      Demand describes how often new missions are requested. Poisson means random demand with an average rate per
      hour; the exact spacing varies and each hour is independent (memoryless). Deterministic means a mission is
      requested
      every fixed interval (e.g., every 4 hours), optionally starting at a given time.
    </div>
