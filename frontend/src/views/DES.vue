...
import ProcessTimes from '../components/des/ProcessTimes.vue'
import SimSettings from '../components/des/SimSettings.vue'
import ScenarioSelector from '../components/des/ScenarioSelector.vue'
import MissionTypes from '../components/des/MissionTypes.vue'
import Demand from '../components/des/Demand.vue'
import SettingsPreview from '../components/des/SettingsPreview.vue'
import Results from '../components/des/Results.vue'
import Timeline from '../components/des/Timeline.vue'
...
const transformedTimeline = computed(() => {
  ...
  for (const item of simulationResults.value.timeline) {
    if (item.type === 'mission' && item.segments) {
      // Assign a unique mission ID to group all segments of this mission
  ...
  <div class="des-container">
    ...
    <div class="section-header">
      ...
      <p class="section-desc">
        Purpose: simulate workflows as discrete events and resource states over time to evaluate throughput, waits, and
        utilization.<br>
        Benefits: captures queues, routing, and resource contention; supports detailed what-if scenarios and scheduling
        policies.<br>
        Best use: operations with constrained resources and process logic (maintenance, sortie generation, turnaround),
        where you need bottleneck analysis and service-level estimates.
      </p>
    </div>

    <!-- Timeline -->
    <Timeline :timeline="transformedTimeline" :horizon-hours="simSettings.horizonHours" />
